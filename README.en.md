...
- Current sample dataset (`data/family.csv`) is expanded to 10 generations: branch `1.1` keeps 3 siblings per generation (gen2~gen10), and branch `1.3` is also extended continuously to generation 10.
